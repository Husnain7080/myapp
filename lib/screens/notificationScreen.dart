...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Alert',style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 25, color: Colors.white)),),
        backgroundColor: Theme.of(context).brightness == Brightness.light ? Colors.red : Colors.red,
      ),
      body: isLoading
