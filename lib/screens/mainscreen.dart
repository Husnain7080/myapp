...
import 'package:event_manager/Others/invite.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> getEventsAndScheduleReminders(String userId) async {
    ...
    for (var event in events) {
      ...
      DateTime reminderDateMorning = eventDate
          .subtract(const Duration(days: 1))
          .add(const Duration(hours: 10, minutes: 00));

      DateTime reminderdate2 = eventDate
          .subtract(const Duration(days: 1))
          .add(const Duration(hours: 14, minutes: 52));

      DateTime reminderdate3 = eventDate
          .subtract(const Duration(days: 1))
          .add(const Duration(hours: 16, minutes: 52));
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Invitefr()));
                // Navigate to feedback page
              },
            ),
            ListTile(
