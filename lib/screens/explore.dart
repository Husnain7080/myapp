    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.red,
          title: Text('Explore',style: GoogleFonts.poppins(textStyle: TextStyle( fontSize: 25, color: Colors.white)),),
      ),
...
class MapPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Map',style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 25, color: Colors.white)),),
      ),
      body: GoogleMap(
